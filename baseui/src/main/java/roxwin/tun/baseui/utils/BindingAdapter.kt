...
//            .apply { RequestOptions.bitmapTransform(RoundedCorners(8)) }
    ...
    @BindingAdapter("kun:bindButtonTintCheckBox")
    ...
    @JvmStatic
    @BindingAdapter("kun:bindGradientBackgroundColor")
...
//    }
    ...
    @JvmStatic
    @BindingAdapter("kun:bindFontTextHint")
    fun bindFontTextHint(inputLayout: TextInputLayout?, type: Int) {
    }

    @JvmStatic
    @BindingAdapter("kun:bindFontToolbar")
